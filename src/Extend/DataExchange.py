...
# SVG export #
##############
def edge_to_svg_polyline(topods_edge, tol=0.1):
...
def export_shape_to_svg(shape, filename=None,
    ...
    for visible_edge in visible_edges:
        visible_svg_line, visible_edge_box2d = edge_to_svg_polyline(visible_edge)
    ...
    if export_hidden_edges:
        for hidden_edge in hidden_edges:
            hidden_svg_line, hidden_edge_box2d = edge_to_svg_polyline(hidden_edge)
